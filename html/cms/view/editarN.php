...
<div class="container" id="cajonEditar">
    <form method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="titulo" id="nombreEditar" value="<?php echo $datos->titulo ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" rows="2" name="entradilla" id="textoEntradilla"> <?php echo $datos->entradilla ?></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="autor" id="claveEditar" value="<?php echo $datos->autor ?>">
        </div>
        <div id="botonesEditar">
        <a type="button" name="volver" id="volverEditar" class="btn btn-primary"   href="<?php echo $_SESSION['home'] ?>panel/noticias">Volver</a>
